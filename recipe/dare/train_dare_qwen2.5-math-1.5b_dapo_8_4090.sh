...
python3 -m recipe.dare.main_dare \
    ...
    actor_rollout_ref.rollout.service.base_url=https://u66551-a192-c2ce2cba.bjc1.seetacloud.com:8443/v1 \
    actor_rollout_ref.rollout.service.model_name=Qwen3-30B-A3B-Instruct-FP8 \
    ...
    actor_rollout_ref.rollout.service.concurrency_limit=2048 \
    ...
    trainer.experiment_name='dare_dapo' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=80 \
    trainer.test_freq=5 \
    trainer.total_training_steps=400 \
    trainer.total_relay_ratio=1.0 \
