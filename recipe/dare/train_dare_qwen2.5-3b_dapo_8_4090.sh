...
python3 -m recipe.dare.main_dare \
    ...
    data.train_files=$HOME/datasets/math/math_dapo/train2nonmath.parquet \
    data.val_files=$HOME/datasets/math/math_dapo/test2nonmath.parquet \
    ...
    trainer.relay_schedule="'[(51, 150, 0.8, 0.2)]'" \
