...
from recipe.dare.dare_ray_trainer import RayDareTrainer
...
class TaskRunner:
    ...
    def run(self, config):
        ...
        if config.actor_rollout_ref.actor.strategy in {"fsdp", "fsdp2"}:
            ...
            from recipe.dare.dare_workers import ActorRolloutRefWorker, AsyncActorRolloutRefWorker
